...
export default function BoysHostel(props) {
                        ...
                        <ButtonGroup  color="primary" aria-label="outlined primary button group">
                            <Button style={{marginLeft: "10px", marginRight: '10px', border:"1px solid"}}
                                size="large" onClick={()=> {setFloor(true)
                                                            handleHostel('B1')}}>B1</Button>
                            <Button style={{marginLeft: "10px", marginRight: '10px', border:"1px solid"}}
                                size="large" onClick={()=> {setFloor(true)
                                                            handleHostel('B2')}} >B2</Button>
                            <Button style={{marginLeft: "10px", marginRight: '10px', border:"1px solid"}}
                                size="large" onClick={()=> {setFloor(true)
                                                            handleHostel('B3')}} >B3</Button>
                        </ButtonGroup>
                        <ButtonGroup  color="primary" aria-label="outlined primary button group">
                        <Button style={{marginLeft: "10px", marginRight: '10px', border:"1px solid"}}
                            size="large" onClick={()=> {setFloor(true)
                                                            handleHostel('B4')}} >B4</Button>
                        <Button style={{marginLeft: "10px", marginRight: '10px', border:"1px solid"}}
                            size="large" onClick={()=> {setFloor(true)
                                                            handleHostel('B5')}} >B5</Button>
                        <Button style={{marginLeft: "10px", marginRight: '10px', border:"1px solid"}}
                            size="large" onClick={()=> {setFloor(true)
                                                            handleHostel('B6')}} >B6</Button>
                    </ButtonGroup>
                    </div>
                )
            }
